...
void buildHuffmanTree(string text){
	...
	// Create a priority queue to store the leaf nodes of Huffman tree;
	...
	while (pq.size() != 1){
		// Remove the two nodes of highest priority, (ie, lowest frequency) from the queue
...
int main(){
	string text = "Its a pleasant morning today!";
